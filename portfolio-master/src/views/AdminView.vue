      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
          ...
          <div class="flex items-center space-x-4">
            <span class="text-sm text-gray-600">Welcome, {{ adminUser?.username }}</span>
            <button
              @click="handleLogout"
    ...
    <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
              ...
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd class="text-lg font-medium text-gray-900">{{ stats.publishedPosts }}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd class="text-lg font-medium text-gray-900">{{ stats.draftPosts }}</dd>
                  </dl>
                </div>
              </div>
            </div>
      ...
      <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
          <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Blog Management</h3>
